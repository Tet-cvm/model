...
const PostMessage = (function() {
  return {
    ...
    m2: function(opt) {
      ...
      let obj = {};
      if (typeof opt === 'object') {
        const { method, callback, failCallback } = opt;
        let { params } = opt;
        if (opt.callbackKey) {
          callbackKey = opt.callbackKey.callbackKey || 'callback';
          failCallbackKey = opt.callbackKey.failCallbackKey || 'failCallback';
        ...
        if (method === 'nativeRequest_v3') {
          params.needEncryptRequest = true;
          params.params = {
            lt: '__lt__',
            accid: '__ttaccid__',
            ttaccid: '__ttaccid__',
            phonenum: '__phonenum__',
            mobile: '__phonenum__',
            oem: '__apptypeid__',
            softtype: '__softtype__',
            softname: '__softname__',
            qid: '__appqid__',
            cqid: '__cleanappqid__',
            ime: '__ime__',
            androidId: '__deviceid__',
            ver: '__ver__',
            os: '__os__',
            device: '__device__',
            position: '__position__',
            city: '__city__',
            os_version: '__osver__',
            iswifi: '__network__',
            device_brand: '__devicebrand__',
            ...params.params
          };
        }
